...
por várias vezes os elfos precisam ficar até tarde 
...
Faltam N minutos para a hora de ir embora, 
e restam dois presentes para o elfo Dobby fabricar. 
...
indicando quantos minutos são necessários para fabricar os dois presentes que Dobby precisa fabricar (1 <= A, B <= 100).
...
ou "Deixa para amanha!" caso contrário.
        ...
        */
        public static void Main(string[] args)
        {
            ...
            int finalExpediente1 = int.Parse(line1[0]);
            ...
            if (finalExpediente1  > totalNecessario )
            {
